...
--
-- Host: localhost
-- Generation Time: Sep 11, 2024 at 01:42 PM
...
-- Database: `spcm`
--
CREATE DATABASE IF NOT EXISTS `spcm` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `spcm`;
...
('nfed0pj2x9vb0rlplh7jxkl4exbz6s81', 'eyJ1c2VyaWQiOjF9:1sgMvB:sxpDlTABo-s3HM8IIAldtYUJS4UCoLtw2jumj79nUgc', '2024-09-03 11:21:05.561562'),
...
('q2byoplm3xgmuck0khy5jb38m2mwu5wg', 'eyJ1c2VyaWQiOjJ9:1sgNhx:tp-KwT_7LP8t-pIZ_WdthrpQa-bCMnkFhRjkpivRm-I', '2024-09-03 12:11:29.669244'),
...
('wbel3mhozclehi3dkqub0az2uf72uaop', 'eyJ1c2VyaWQiOjN9:1qVWcu:p9c-9gYP-GqxvjQaZ9_erYlXIkPwBqwHn83aMN3-8pU', '2023-08-28 12:24:52.623304'),
...
('y700q8swvt1dt42iq0zjsnjo07nofezb', 'eyJ1c2VyaWQiOjV9:1qVoVx:2wnaPtxXrVYJL8muNRx7WqC2uQ-Pv5iLTwD91-J2JrQ', '2023-08-29 07:30:53.069549'),
...
(1, 'Mohan', 'Mohan123@gmail.com', 'Mohan', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(6, 'KNeighborsClassifier', '65.22864538395167'),
(7, 'SVM', '76.96289905090595'),
(8, 'Random Forest Classifier', '78.86108714408974');
...
--
-- Table structure for table `remote_user_detect_stock_recommendation`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_stock_recommendation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_detect_stock_recommendation`
--

INSERT INTO `remote_user_detect_stock_recommendation` (`id`, `Text`, `Username`, `Datetime`, `Prediction`) VALUES
(1, 'GOOG - ower trend line channel test & volume support.', 'Eruditi0DTE', '2023-02-06 09:55:22+00:00', 'Positive'),
(2, 'Won''t believe AAP uptrend is back until it crosses above MA(50)', 'EricaTe85892054', '2023-02-06 09:06:01+00:00', 'Negative'),
(3, ' red, not ready for break out.', 'Felicia51342059', '2023-02-06 08:53:42+00:00', 'Negative'),
(4, 'Some of the watch list stocks that triggered today OEX AGNX TV VBD XIDE PPC EXP  ONTY  BMN FS WK CHMT FBC  ISI AIG', 'Keith82084334', '2023-02-06 06:30:19+00:00', 'Positive');

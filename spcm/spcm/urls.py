...
urlpatterns = [
    ...
    url(r'^Predict_Stock_Recommendation_Type/$', remoteuser.Predict_Stock_Recommendation_Type, name="Predict_Stock_Recommendation_Type"),
    ...
    url(r'^View_Prediction_Of_Stock_Recommendation_Type_Ratio/$', serviceprovider.View_Prediction_Of_Stock_Recommendation_Type_Ratio, name="View_Prediction_Of_Stock_Recommendation_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Stock_Recommendation_Type/$', serviceprovider.View_Prediction_Of_Stock_Recommendation_Type, name="View_Prediction_Of_Stock_Recommendation_Type"),
